 ...
 * @author admin
 */
public class QuanLyMonHoc extends javax.swing.JDialog {

    /**
     * Creates new form QuanLyMonHoc
     */
    public QuanLyMonHoc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuanLyMonHoc dialog = new QuanLyMonHoc(new javax.swing.JFrame(), true);
